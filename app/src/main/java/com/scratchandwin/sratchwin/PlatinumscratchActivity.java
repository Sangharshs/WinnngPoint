...
public class PlatinumscratchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_platinumscratch);
        ...
        rewardedVideoAdListener = new RewardedVideoAdListener() {
            ...
            public void onError(Ad ad, AdError error) {
                //Toast.makeText(PlatinumscratchActivity.this, "" + error.getErrorMessage(), Toast.LENGTH_SHORT).show();
            ...
            public void onRewardedVideoCompleted() {
                ...
                Toast.makeText(PlatinumscratchActivity.this, "Task Complete", Toast.LENGTH_SHORT).show();
                loadVideoAd();
                recreate();
        ...
        scratchView.setRevealListener(new ScratchView.IRevealListener() {
            ...
            public void onRevealed(ScratchView scratchView) {
                    ...
                    SharedPreferences getScratchLimit = getSharedPreferences("scratch3", MODE_PRIVATE);
...
////                editor1.putString("scratch_limit", String.valueOf(DAILY_SCRATCH));
////                editor1.apply();
////                recreate();
...
//        }
    ...
    public void show_winning_box() {
        ...
        collect_now_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (rewardedVideoAd.isAdLoaded()) {
                    ...
                    //  loadVideoAd();
                    Toast.makeText(PlatinumscratchActivity.this, "विज्ञापन देखने के बाद ही आपके खाते में पैसा डाला जाएगा|",Toast.LENGTH_LONG).show();
                    recreate();
                }
                alertDialog.cancel();
            }
        ...
        not_now_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                Toast.makeText(PlatinumscratchActivity.this, "Coins Are Not Collected", Toast.LENGTH_SHORT).show();
                recreate();
            }
        });
    ...
    public void inflateAd(NativeAd nativeAd) {
        ...
        LayoutInflater inflater = LayoutInflater.from(PlatinumscratchActivity.this);
        ...
        AdOptionsView adOptionsView = new AdOptionsView(PlatinumscratchActivity.this, nativeAd, nativeAdLayout);
