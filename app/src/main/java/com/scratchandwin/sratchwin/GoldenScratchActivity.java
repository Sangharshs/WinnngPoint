...
public class GoldenScratchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_goldencard);
        ...
        rewardedVideoAdListener = new RewardedVideoAdListener() {
            ...
            public void onRewardedVideoCompleted() {
                ...
                Toast.makeText(GoldenScratchActivity.this, "Task Complete", Toast.LENGTH_SHORT).show();
                loadVideoAd();
                recreate();
    ...
    public void show_winning_box() {
        ...
        collect_now_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (rewardedVideoAd.isAdLoaded()) {
                    ...
                    //  loadVideoAd();
                    Toast.makeText(GoldenScratchActivity.this, "विज्ञापन देखने के बाद ही आपके खाते में पैसा डाला जाएगा|",Toast.LENGTH_LONG).show();
                    recreate();
                }
                alertDialog.cancel();
            }
        ...
        not_now_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                Toast.makeText(GoldenScratchActivity.this, "Coins Are Not Collected", Toast.LENGTH_SHORT).show();
                recreate();
            }
        });
    ...
    public void inflateAd(NativeAd nativeAd) {
        ...
        LayoutInflater inflater = LayoutInflater.from(GoldenScratchActivity.this);
        ...
        AdOptionsView adOptionsView = new AdOptionsView(GoldenScratchActivity.this, nativeAd, nativeAdLayout);
